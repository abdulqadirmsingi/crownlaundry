        ...
        <div v-if="selectedItems.length > 0" class="mb-6">
          ...
          <div class="bg-gray-100 p-4 rounded-md">
            <div
              ...
              :key="index"
              class="flex justify-between items-center mb-2 p-2 bg-white rounded shadow"
            >
    ...
    <section class="py-16 bg-indigo-50">
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div
              class="bg-white rounded-lg shadow-lg p-6 h-full flex flex-col relative transform hover:scale-105 transition duration-300"
            >
              <div class="flex-grow">
    ...
    <section class="py-16 bg-white">
      <div class="container mx-auto px-4">
        ...
        <div class="sponsor-carousel overflow-hidden">
          <div
            class="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8"
          >
            <img
